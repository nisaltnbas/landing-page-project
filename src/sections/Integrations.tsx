...
import slackcon from "@/assets/images/slack-logo.svg";
...
const integrations = [
    ...
    { name: "Slack", icon: slackcon, description: "Slack is a powerful team communication platform." },
        ...
        <div className="grid lg:grid-cols-2 items-center lg:gap-16">
            <div>
                ...
                <p className="text-white/50 mt-4 text-lg">
                    ...
                    making it easy yo plug into any workflow and collaborate 
                    across platforms.
                </p>
        </div>
        <div>
            <div className="h-[400px] lg:h-[800px] mt-8 lg:mt-0 overflow-hidden md:grid grid-cols-2 gap-4 [mask-image: linear-gradient(to_bottom, transparent, black_10%, black_90%, transparent)]">
